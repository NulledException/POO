public class Teste {
	public static void main(String[] args) {
		...
		System.out.println("O contato José existe? " + contatos.buscarContato("José")); // busco se ele existe, nesse
																						// caso imprime true, pois eu
																						// acabei de adicionar ele
		...
		System.out.println("O contato José existe? " + contatos.buscarContato("José")); // busco novamente pelo José,
																						// aqui imprime false, pois eu
																						// acabei de removê-lo
